...
const validateRegistration = (req, res, next) => {
    ...
    //If all validations pass, the next function is called, allowing the request to process th the next middleware or route handler.
...
app.get('/login', (req, res) => {
    res.render('login', {
        //retrive success and error message from the flash middleware and
